  ...
  const firstUnseenIndex = useMemo(
    ...
    return (
      ...
      {adding && (
        ...
        >
          <div
            className="w-full max-w-lg max-h-[100dvh] overflow-y-auto rounded-2xl border border-white/10 bg-gradient-to-b from-zinc-900 to-zinc-950 backdrop-blur-xl text-white p-4"
            onClick={(e) => e.stopPropagation()}
          >
