    ...
    <>
      ...
      >
        <div className="absolute inset-0 p-3 sm:p-6 flex justify-center">
          ...
          {/* Title + Authors */}
          <div className="px-4 pt-4 pb-0.5 flex-1 overflow-hidden">
            <h2
